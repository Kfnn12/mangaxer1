...
export function AZList({ currentLetter, onSelectLetter }: AZListProps) {
  return (
    <div className="w-full flex-col items-center mt-12 bg-zinc-900 border border-white/5 rounded-xl p-6 hidden sm:flex shadow-2xl">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        {ALPHABET.map((char) => (
          <button
            ...
            className={`w-10 h-10 flex items-center justify-center font-bold text-sm rounded transition-colors ${
              currentLetter === char 
